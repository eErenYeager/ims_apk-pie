...
public class ImsCallSessionImpl extends IImsCallSession.Stub {
   ...
   public void setListener(IImsCallSessionListener listener) {
    ...
    private boolean maybeUpdateLowBatteryStatus() {
        ...
        Log.v(this, "maybeUpdateLowBatteryStatus isLowBattery");
    ...
    private void updateImsCallProfile(DriverCallIms dc) {
        ...
        if (dc.historyInfo != null && !dc.historyInfo.isEmpty()) {
            mCallProfile.mCallExtras.putStringArrayList(
        ...
        if (mDc!= null && !mDc.isMT && ImsCallUtils.isCarrierOneSupported() &&
                ImsCallUtils.hasCallTypeChangedToVoice(mDc, dc) &&
